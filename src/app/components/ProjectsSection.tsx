        ...
        <section className="flex flex-col lg:flex-row gap-8 lg:gap-16 mt-6 md:mt-10 mx-auto max-w-screen-xl w-full px-6" id="projects">
            ...
            <ul className="grid gap-8 min-w-[40%]">
                {projects.map((project) => (
                    <li key={project.id} className="flex flex-col w-full items-center justify-between rounded-lg bg-secondary pt-2 md:pt-6 lg:pt-10 pb-4 lg:pb-8 px-4 lg:px-6 sticky h-screen">
                        ...
                        <div className="flex flex-col w-full mt-8 lg:mb-8">
                            <Progress indicatorClassName="bg-[#F9AE00] rounded-r-full" value={20} className="h-2 md:h-4 mt-8 lg:hidden" />

...
export function GeneralDonationModal({ children }: GeneralDonationModalProps) {
    ...
    const handleSubmit = paymentForm.handleSubmit(async (data) => {
        ...
        try {
            ...
            const paymentData = {
                amount: data.amount,
                currency: 'RUB',
                description: 'Пожертвование для поддержки фонда',
    ...
    return (
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>Поддержать фонд</DialogTitle>

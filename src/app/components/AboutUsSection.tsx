    ...
    return (
        <section className="flex flex-col mx-auto max-w-screen-xl w-full px-6 md:-mt-12" id="about-us">
            <div className="flex items-center flex-col">
                ...
                <p className="text-muted-foreground text-base md:text-2xl max-w-screen-sm text-center leading-tight mt-6"><span className="font-medium text-foreground">Проект «Добрёнок» — это сердце нашего фонда,</span> пространство, где дети вдохновляют взрослых на добрые дела, развитие и новые идеи.</p>
            </div>
